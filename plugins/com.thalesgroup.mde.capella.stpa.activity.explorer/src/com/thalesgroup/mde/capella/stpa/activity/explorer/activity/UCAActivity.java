...
public class UCAActivity extends AbstractNewUnlocatedRepresentationActivity {
  ...
  protected EClass getLocationType() {
    return StpaPackage.eINSTANCE.getControlAction();
  }
  ...
  public String getRepresentationName() {
    return ISTPAAnalysisConstants.TABLE_UCA_NAME;
  }
