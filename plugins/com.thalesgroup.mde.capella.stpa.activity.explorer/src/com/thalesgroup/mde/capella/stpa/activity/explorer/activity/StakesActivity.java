...
public class StakesActivity extends AbstractSTPAAnalysisNewRepresentationActivity {
  ...
  protected StpaAnalysisElement getModelElementCore(EObject root) {
    return STPAQueryHelper.getOrCreateAnalysisPackage(
        ...
        StpaPackage.Literals.STPA_ANALYSIS__LOSS_PACKAGE);
  }
  
  @Override
  public String getRepresentationName() {
    return ISTPAAnalysisConstants.TABLE_STAKES_NAME;
  }
