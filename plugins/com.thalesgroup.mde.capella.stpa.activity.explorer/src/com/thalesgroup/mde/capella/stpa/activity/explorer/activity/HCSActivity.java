...
public class HCSActivity extends AbstractSTPAAnalysisNewRepresentationActivity {
  ...
  protected StpaAnalysisElement getModelElementCore(EObject root) {
    return STPAQueryHelper.getOrCreateAnalysisPackage(
        ...
        StpaPackage.Literals.STPA_ANALYSIS__CONTROL_STRUCTURE_PACKAGE);
  }
  
  @Override
  public String getRepresentationName() {
    return ISTPAAnalysisConstants.DIAGRAM_HCS_NAME;
  }
