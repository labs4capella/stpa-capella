...
public class LossScenariosActivity extends AbstractSTPAAnalysisNewRepresentationActivity {
  ...
  protected StpaAnalysisElement getModelElementCore(EObject root) {
    return STPAQueryHelper.getOrCreateAnalysisPackage(
        ...
        StpaPackage.Literals.STPA_ANALYSIS__LOSS_SCENARIO_PACKAGE);
  }
  
  @Override
  public String getRepresentationName() {
    return ISTPAAnalysisConstants.TABLE_LSCENARIO_NAME;
  }
