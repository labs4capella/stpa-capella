...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.mde.capella.stpa.model.Mitigable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MitigableItemProvider extends StpaAnalysisElementItemProvider {
  /**
   ...
   * @generated
   */
  public MitigableItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
    String label = ((Mitigable) object).getName();
    return label == null || label.length() == 0 ? getString("_UI_Mitigable_type") : //$NON-NLS-1$
        getString("_UI_Mitigable_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
