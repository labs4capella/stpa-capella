...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.mde.capella.stpa.model.ControlFlawAnalysisElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlFlawAnalysisElementItemProvider extends UserIdentifiedElementItemProvider {
  /**
   ...
   * @generated
   */
  public ControlFlawAnalysisElementItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
    String label = ((ControlFlawAnalysisElement) object).getName();
    return label == null || label.length() == 0 ? getString("_UI_ControlFlawAnalysisElement_type") : //$NON-NLS-1$
        getString("_UI_ControlFlawAnalysisElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
